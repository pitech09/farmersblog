...
class ProdConfig(BaseConfig):
    ...
    SECURITY_HEADERS = {
        ...
        'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://res.cloudinary.com; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net; img-src 'self' data: https://res.cloudinary.com; media-src 'self' https://res.cloudinary.com; font-src 'self'; connect-src 'self'; frame-ancestors 'none';",
